...
export const collegiateFaq: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Many collegiate circuits split Newcomer into two tiers: Newcomer I for absolute first-timers, Newcomer II for slightly more experienced newcomers. That way, true beginners aren't competing directly against people who've already danced a season or two.",
  },
  {
