...
export const dances: Dance[] = [
  ...
  },
  {
    ...
    funFact: "Quickstep was created in the 1920s specifically because Foxtrot's tempo couldn't keep up with the fast jazz music of the era, and dancers needed something quicker.",
    videoId: '5y7XQ3_3iK4',
  ...
  },
  {
    ...
    videoId: 'DVP_jQWFt4U',
    videoTitle: 'The Way I Are by Timbaland ft. Keri Hilson (Cha Cha)',
    videoIsOwn: true,
  ...
  },
  {
    ...
    videoId: 'HF03lxtDiHA',
    videoTitle: 'Hey Sailaa by Abhaya & The Steam Engines (Rumba)',
    videoIsOwn: true,
    videoOrientation: 'vertical',
  ...
  },
  {
    ...
    videoId: '0GQny2TxNvg',
    videoTitle: "Hips Don't Lie by Shakira (Samba)",
    videoIsOwn: true,
    videoOrientation: 'vertical',
  ...
  },
  {
    ...
    description:
      "A fast, bouncy swing dance built from kicks, flicks, and triple steps. Jive is technically classed as a Latin dance in competition, but it feels like rock-and-roll: energetic, upbeat, and a great cardio workout.",
    ...
    videoId: '2NWMYQhewU0',
    videoTitle: 'Part Time Lover by Stevie Wonder (Jive)',
    videoIsOwn: true,
    videoOrientation: 'vertical',
  ...
  },
  {
    ...
    description:
      "A simplified, beginner-friendly form of swing dancing built on a 6-count triple-step pattern. It's easygoing, forgiving of timing mistakes, and works with almost any upbeat pop, rock, or swing music, making it a great first social dance.",
    ...
    videoId: 'DkYEa8znf0s',
    videoTitle: 'Beat It by Michael Jackson (Swing)',
    videoIsOwn: true,
    videoOrientation: 'vertical',
  ...
  },
  {
    ...
    videoId: 'Tq8oHfesmM0',
    videoTitle: "Hips Don't Lie by Shakira, Ed Sheeran, Beéle (Salsa)",
    videoIsOwn: true,
    videoOrientation: 'vertical',
  ...
  },
  {
    ...
    videoId: 'qIGiqUnPTic',
    videoTitle: 'Bad Dreams by Teddy Swims (Hustle)',
    videoIsOwn: true,
    videoOrientation: 'vertical',
  ...
  },
  {
    ...
    videoId: 'tOOYyu4rPEg',
    videoTitle: 'La Bachata by Manuel Turizo (Bachata)',
    videoIsOwn: true,
    videoOrientation: 'vertical',
